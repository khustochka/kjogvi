defmodule Kjogvi.Repo.Migrations.RenameCardsToChecklists do
  ...
  # Columns of `checklists` whose NOT NULL constraints carry the table name.
  @not_null_columns ~w(id observ_date location_id effort_type motorless legacy_autogenerated resolved inserted_at updated_at user_id)
  ...
  def up do
    ...
    for col <- @not_null_columns do
      execute "ALTER TABLE checklists RENAME CONSTRAINT cards_#{col}_not_null TO checklists_#{col}_not_null"
    end

    execute "ALTER TABLE observations RENAME CONSTRAINT observations_card_id_not_null TO observations_checklist_id_not_null"
  ...
  def down do
    ...
    execute "ALTER TABLE observations RENAME CONSTRAINT observations_checklist_id_not_null TO observations_card_id_not_null"

    for col <- @not_null_columns do
      execute "ALTER TABLE checklists RENAME CONSTRAINT checklists_#{col}_not_null TO cards_#{col}_not_null"
    end
