defmodule KjogviWeb.Router do
  ...
  scope "/my", KjogviWeb do
    ...
    live_session :require_authenticated_user,
      ...
      live "/cards", Live.My.Checklists.Index, :index
      live "/cards/page/:page", Live.My.Checklists.Index, :index
      live "/cards/new", Live.My.Checklists.Form, :new
      live "/cards/:id/edit", Live.My.Checklists.Form, :edit
      live "/cards/:id", Live.My.Checklists.Show, :show
