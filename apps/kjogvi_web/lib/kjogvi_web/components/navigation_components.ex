defmodule KjogviWeb.NavigationComponents do
  ...
  ## Examples
      ...
      <.icon_link navigate={~p"/my/cards/1/edit"} icon="hero-pencil-square" label="Edit checklist" />
      <.icon_link navigate={~p"/my/cards/1"} icon="hero-clipboard-document-list" label="View checklist" class="text-gray-400" />
  """
  attr :navigate, :string, default: nil
  attr :patch, :string, default: nil
  attr :href, :string, default: nil
