defmodule OrnithoWeb.CoreComponents do
  @moduledoc """
  ...
  def input(%{type: "checkbox", value: value} = assigns) do
    ...
    ~H"""
    <div>
      <label for={@id} class="flex items-center gap-4 text-sm leading-6 text-zinc-600">
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(OrnithoWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(OrnithoWeb.Gettext, "errors", msg, opts)
    end
  end
